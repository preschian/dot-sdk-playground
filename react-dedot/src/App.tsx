    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Polkadot Portfolio</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">Track your assets across multiple Polkadot ecosystem networks</p>
          ...
          <div className="max-w-md mx-auto">
            ...
            />
            <p className="text-xs text-gray-500 mt-2">Leave empty to use the default address</p>
          </div>
        </div>
            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-3 h-3 rounded-full ${network.chain === "polkadot" ? "bg-pink-500" : network.chain === "kusama" ? "bg-gray-800" : "bg-emerald-500"}`}
                  />
                  <h2 className="text-xl font-semibold text-gray-900 capitalize">{network.chain}</h2>
                </div>
              ...
              <div className="space-y-4">
                ...
                {network.error && (
                  <div className="text-center py-12">
                    <div className="text-red-500 text-sm">Connection failed</div>
                  </div>
                )}
                ...
                {network.data && !network.loading && (
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-sm font-mono text-gray-800 truncate">{network.data.name}</div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="p-4 border border-gray-200 rounded-lg">
                        ...
                        <div className="text-lg font-semibold text-gray-900">{network.data.freeBalance.toFixed(4)}</div>
                        <div className="text-xs text-gray-500">{getTokenSymbol(network.chain)}</div>
                      </div>

                      {/* NFTs */}
                      <div className="p-4 border border-gray-200 rounded-lg">
                        <div className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">NFTs</div>
                        <div className="text-lg font-semibold text-gray-900">{network.data.nfts}</div>
